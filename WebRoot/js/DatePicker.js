...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar .day li,.calendar .date li{float:left;width:14.13%;height:16px;line-height:16px;text-align:center;}";
	...
	strStyle += ".calendarBottom li{float:left;height:20px;line-height:20px;text-align:center;}";
	strStyle += "</style>";
	return strStyle;
}
